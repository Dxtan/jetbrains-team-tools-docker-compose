# Default arguments
ARG jdkLinuxARM64Component='https://corretto.aws/downloads/latest/amazon-corretto-8-aarch64-linux-jdk.tar.gz'
ARG jdkLinuxARM64ComponentMD5SUM='5db858d2c009d4ab488a9d116da730d4'
